...
public class ReplyServiceImpl implements ReplyService {
    ...
    public void reply(int sessionUid, int pid, String content) {
        ...
        //插入一条回复消息
        taskExecutor.execute(new MessageTask
                (messageMapper,userMapper,postMapper,replyMapper,pid,0,sessionUid, MyConstant.OPERATION_REPLY));
